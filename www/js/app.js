...
// Generated by CoffeeScript 1.6.1
(function() {
  var BaseView, HomeView, ResultView, db, device, getByRole, map, renderer, views, vowels,
    _this = this,
  ...
  HomeView = (function(_super) {
    ...
    HomeView.prototype.bind = function() {
      ...
      return db.getAll(function(data) {
        var savedList;
        savedList = $(renderer.render('partials/saved-list'));
        return savedList.appendTo(this.elements.savedList);
      });
    };
